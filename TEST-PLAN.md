...
actual spawn to the host backend, so orchestration tests really run a turn. The LIVE checks below
are the v0.8 Xavier deployment gate and are executed in the QA loop that follows this slice.
