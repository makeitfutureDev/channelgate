...
- [ ] Counsel reviewed license **v1.2** — specifically §3.1 (dedicated deployments, per customer,
...
- [ ] Every commit in the candidate carries a `Signed-off-by` trailer per `CLA.md`, and any
      contribution predating the CLA has a recorded acceptance.
- [ ] The published version's public-availability date is recorded in `CHANGELOG.md`.
- [ ] Version/tag/changelog and `docs/COMPATIBILITY.md` match the candidate.
