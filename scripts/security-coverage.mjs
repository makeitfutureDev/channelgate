...
const areas = [
  ...
  //
  // browser-env.js is the third file in this area for the same reason: it decides WHICH channel's
  // browser daemon a run attaches to, and that daemon is spawned outside the folder sandbox with
