...
// normal channel/session stack: Claude runs cold on the daemon host (the local runtime, never a
// channel container) in a temporary gateway-owned folder, with project/user MCPs replaced by an
// empty strict config, memory disabled, bypass/auto modes disabled, and EVERY tool denied — the
// deny list is the probe's confinement; it has no shell to sandbox.
