...
| Check disk space, stale containers or old runtime images | `references/administration.md` | Host `/sudo` thread: `df -h /`, `podman system df -v` — report and ask; never delete on your own |
