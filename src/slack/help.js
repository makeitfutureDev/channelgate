...
export const HELP_TEXT =
  ...
  "• *Control a live run:* type `stop` in that thread or react 🛑 to stop just that run. `/stop` at top level stops every active run in this channel. If you send another message while I work, choose *Steer Conversation*, *Add to Queue*, or *Cancel Request*; the choice card disappears after a valid selection. `/next <message>` queues directly without asking.\n" +
