...
// Platforms that have a transport in the tree at all. A "scaffold" is a descriptor + formatter only.
// This is NOT "connected": whether credentials are saved and a connection is up is runtime state
// (see live.js), and an unconnected platform's connector still throws on write rather than
