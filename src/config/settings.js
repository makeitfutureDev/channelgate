...
export function getContainerRuntime() {
  ...
  return {
    ...
    // Off by default: a secret with no egress rule is injected raw and flagged unprotected. On: it
    // is withheld from proxy-mode containers entirely.
    egressSecretsStrict: s.containerEgressSecretsStrict === true,
  };
}
