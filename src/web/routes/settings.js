...
import { invalidModelOrEffort, cleanDmTemplate, cleanAccessGrants } from "./helpers.js";
...
export function createSettingsRouter({
  ...
  router.put("/settings", async (req, res, next) => {
    try {
      ...
      if (typeof body.publicUrl === "string") patch.publicUrl = body.publicUrl.trim().replace(/\/+$/, "");
