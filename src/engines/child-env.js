...
// Exported so config/channel-env.js can reserve these names for per-channel secrets from ONE
// source of truth: a channel variable named PATH/HOME/ANTHROPIC_BASE_URL would win over the value
// the daemon just set (the `extra` merge below is deliberately last).
export const PASSTHROUGH_ENV_NAMES = new Set([
  "PATH",
  "HOME",
  "USER",
  "LOGNAME",
...
function isAllowed(name) {
  return PASSTHROUGH_ENV_NAMES.has(name);
}
